...
public class TripletTests {
    ...
    void holeTest(){
        ...
        System.out.println("Container 0: " + Arrays.toString(cntr));
    ...
    void removeContainerTest(){
        ...
        System.out.println("Container 0: " + Arrays.toString(cntr));
        System.out.println("Container 1: " + Arrays.toString(cntr1));
        System.out.println("Container 2: " + Arrays.toString(cntr2));
